...
*  FILE:        game_sa/CExecutiveManagerSA.task.h
...
public:
    ...
    CFiberSA *runtimeFiber;

    typedef void (__stdcall*taskexec_t)( CExecTaskSA *task, void *userdata );

    taskexec_t callback;

    RwListEntry <CExecTaskSA> node;
    ...
    CExecTaskSA( CExecutiveManagerSA *manager, CFiberSA *runtime )
    {
