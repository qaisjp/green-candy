...
static PluginDependantStructRegister <privateNativeThreadEnvironment, executiveManagerFactory_t> privateNativeThreadEnvironmentRegister( executiveManagerFactory );
