...
void	LoadReplaceIDE(const char *filename)
{
	...
	for (iter = ide->m_objects.begin(); iter != ide->m_objects.end(); iter++)
	{
		if ((*iter)->m_flags & (OBJECT_ALPHA1 | OBJECT_ALPHA2 | OBJECT_NOCULL | OBJECT_BREAKGLASS | OBJECT_BREAKGLASS_CRACK | OBJECT_GARAGE | OBJECT_MULTICLUMP | OBJECT_USE_POLYSHADOW | OBJECT_EXPLOSIVE | OBJECT_UNKNOWN | OBJECT_UNKNOWN_2 | OBJECT_GRAFFITI | OBJECT_NOBACKFACECULL | OBJECT_STATUE | OBJECT_UNKNOWN_HIGH | OBJECT_VEGETATION | OBJECT_BIG_VEGETATION | OBJECT_SCM | OBJECT_NIGHTTIME))
