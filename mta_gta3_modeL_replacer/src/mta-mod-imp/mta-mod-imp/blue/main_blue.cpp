...
static inline void luaBegin( FILE *file )
{
	fprintf( file, 
...
static inline void luaMethodBegin( FILE *file )
{
	fprintf( file,
...
static inline void luaModelBeginLoader( FILE *file )
{
	fprintf( file,
		"function loadModels ()\n" \
...
static inline void luaModelLoadBegin( FILE *file )
{
	if (!staticCompile)
	{
		fprintf( file,
...
static inline void luaModelLoadEntry( FILE *file, const char *name, const char *txdName, unsigned short id, const char *lod, unsigned short lodID )
{
	if (staticCompile)
	{
		fprintf( file,
...
static inline void luaModelLODBegin( FILE *file )
{
	if ( !staticCompile )
	{
		fprintf( file,
...
static inline void luaModelLODEntry( FILE *file, unsigned short id, const char *name, const char *colName, const char *txdName, const char *lod, unsigned short super )
{
	if ( !staticCompile )
	{
		if ( tableCount++ != 0 )
...
static inline void luaModelLODEnd( FILE *file )
{
	if ( !staticCompile )
	{
		fprintf( file,
...
static inline void luaModelLoadEnd( FILE *file )
{
	if (!staticCompile)
	{
		fprintf( file,
...
static inline void luaMethodEnd( FILE *file )
{
	switch( streamMethod )
	{
...
static inline void luaEnd( FILE *file )
{
	if ( cached )
	{
		fprintf( file,
